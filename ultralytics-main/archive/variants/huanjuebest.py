...
class MainWindow(QMainWindow):
    ...
    def check_txt_files(self):
        ...
        if any(file.endswith('.txt') for file in os.listdir(directory)):
            print("已发送NEEPU-HJ-R1.txt到裁判盒,识别结束")
            self.close()
        else:
            print("结果文件未生成")
    ...
    def send_result(self, file_path):
        file_path = '/home/HwHiAiUser/Desktop/result_r/NEEPU-HJ-R1.txt'
    ...
    def process_detection_cycle(self):
        ...
        output_path = '/home/HwHiAiUser/ultralytics-main/runss/result/NEEPU-HJ-R1.txt' 
        time.sleep(2)
        ...
        for folder in folders:
            stable_targets = self.process_folder(folder, min_occurrences=5)                                           #注意调整
        ...
        with open(output_path, 'w') as f:
            ...
            f.write("END\n")
        print(f"NEEPU-HJ-R1.txt已生成,路径为：{output_path}")
    ...
    def start_detection(self):
        ...
        self.fps_timer.start(1000)  # 启动FPS计时器
